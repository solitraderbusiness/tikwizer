...
def get_task_child(node):
    ...
    class_template = class_template(path_task_id_template)

    field_data_static = field_data(path_task_id)

    constructor_data_static = constructor_data(path_task_id)

    run_data_static = run_data(path_task_id)

    reset_data_static = reset_data(path_task_id)

    function_data_static = function_data(path)
...
def class_template (path_task_id_template):
...
def run_data_static (path_task_id):
...
def reset_data_static (path_task_id):
...
def function_data_static (path_task_id):
...
def constructor_data_static (path_task_id):
...
def field_data_static (path_task_id):
