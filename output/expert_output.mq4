   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      MovingAverage46_left movingaverage46_left;
      movingaverage46_left.init();
      double valueMovingAverage46_left = movingaverage46_left.calc();
      MovingAverage46_right movingaverage46_right;
      movingaverage46_right.init();
      double valueMovingAverage46_right = movingaverage46_right.calc();

      if(valueMovingAverage46_left > valueMovingAverage46_right)
        {
...
public:
                     Block46()
     {
      ...
      task = new Task46(name);
     }
  };
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
class Block41 : public Block
  {
public:
                     Block41()
     {
      ...
      task = new Task41(name);
     }
  };
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
class Block37 : public Block
  {
public:
                     Block37()
     {
...
void addBlocksTick()
  {
   ...
   Block46 *block46 = new Block46();
   Block41 *block41 = new Block41();
   Block37 *block37 = new Block37();
   Block50 *block50 = new Block50();
   Block47 *block47 = new Block47();

   blocks_tick[0] = block46;
   blocks_tick[1] = block41;
   blocks_tick[2] = block37;
   blocks_tick[3] = block50;
   blocks_tick[4] = block47;
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
