...
class MarketPropertiesAskBidMid2_left1
   ...
   T                 calc()
     {
      ...
      return result + result*14/NormalizeDouble(100,0);

     }
  };
class MarketPropertiesAskBidMid2_left2
...
public:
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      MarketPropertiesAskBidMid2_left1 marketPropertiesAskBidMid2_left1;
   marketPropertiesAskBidMid2_left1.init();
   double valueMarketPropertiesAskBidMid2_left1 = marketPropertiesAskBidMid2_left1.calc<double>();
      MarketPropertiesAskBidMid2_left2 marketPropertiesAskBidMid2_left2;
   marketPropertiesAskBidMid2_left2.init();
   double valueMarketPropertiesAskBidMid2_left2 = marketPropertiesAskBidMid2_left2.calc<double>();
   ...
   double valueMovingAverage2_right2 = movingaverage2_right2.calc();
      ...
      if(valueMarketPropertiesAskBidMid2_left1 > valueMovingAverage2_right1 && valueMarketPropertiesAskBidMid2_left2 < valueMovingAverage2_right2)
        {
