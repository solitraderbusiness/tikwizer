                     ...
                     if(label_1 != "")
                       {
                        ...
                        text    = FormatValueForPrinting("", format_number_1, format_time_1);
                       }
      ...
      for(int i = 0; i < how_many_regions; i++)
        {
         ...
         if(i==0)  //part 1
           {
            double max_part_1_sudo = maxPart;
            double min_part_1_sudo = minPart;
            double mtp_part_1_sudo = xIndex;
           }
         else
            if(i==1)  //part 2
              {
               double max_part_2_sudo = maxPart;
               double min_part_2_sudo = minPart;
               double mtp_part_2_sudo = xIndex;
              }
            else
               if(i==2)  //part 3
                 {
                  double max_part_3_sudo = maxPart;
                  double min_part_3_sudo = minPart;
                  double mtp_part_3_sudo = xIndex;
                 }
               else
                  if(i==3)  //part 4
                    {
                     double max_part_4_sudo = maxPart;
                     double min_part_4_sudo = minPart;
                     double mtp_part_4_sudo = xIndex;
                    }
                  else
                     if(i==4)  //part 5
                       {
                        double max_part_5_sudo = maxPart;
                        double min_part_5_sudo = minPart;
                        double mtp_part_5_sudo = xIndex;
                       }
