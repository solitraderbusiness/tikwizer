...
public:
     ...
     {
      /* Calculations */
      RangeMode = VP_RANGE_MODE_LAST_MINUTES;              // Range mode
      RangeMinutes = 1440;        // Range minutes
      ModeStep =    100;             // Mode step (points)
      HgPointScale = POINT_SCALE_20;        // Point scale
      ...
      ModeLevelColor = clrRed;    // Mode level line color (None=disable)
