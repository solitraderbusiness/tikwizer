   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      if(SetObjPrice1)
        {
         Value1_price_1 value1_price_1;
         value1_price_1.init();
         string valueValue1_price_1 = value1_price_1.calc<string>();
         ObjectSetDouble(chart_id,name,OBJPROP_PRICE,0,valueValue1_price_1);//price1
        }
      ...
      if(SetObjTime2)
        {
         ...
         ObjectSetInteger(chart_id,name,OBJPROP_TIME,1,valueValue1_time_2);//time2
        }
      if(SetObjPrice2)
        {
      ...
      if(SetObjPrice3)
        {
         Value1_price_3 value1_price_3;
         value1_price_3.init();
         string valueValue1_price_3 = value1_price_3.calc<string>();
         ObjectSetDouble(chart_id,name,OBJPROP_PRICE,2,valueValue1_price_3);//price3
        }
