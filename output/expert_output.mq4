   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      RSI14_left1 rsi14_left1;
      rsi14_left1.init();
      double valueRSI14_left1 = rsi14_left1.calc();
      RSI14_left2 rsi14_left2;
      rsi14_left2.init();
      double valueRSI14_left2 = rsi14_left2.calc();
      Value14_right1 value14_right1;
      value14_right1.init();
      double valueValue14_right1 = value14_right1.calc();
      Value14_right2 value14_right2;
      value14_right2.init();
      double valueValue14_right2 = value14_right2.calc();

      if(valueRSI14_left1 < valueValue14_right1 && valueRSI14_left2 > valueValue14_right2)
        {
