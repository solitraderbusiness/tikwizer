...
class MarketPropertiesHighestCandle2_left
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      MarketPropertiesHighestCandle2_left marketPropertiesHighestCandle2_left;
      marketPropertiesHighestCandle2_left.init();
      int valueMarketPropertiesHighestCandle2_left = marketPropertiesHighestCandle2_left.calc<int>();
      ...
      if(valueMarketPropertiesHighestCandle2_left > valueMovingAverage2_right)
        {
