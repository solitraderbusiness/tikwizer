   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      MACD3_left macd3_left;
      macd3_left.init();
      double valueMACD3_left = macd3_left.calc();
      MACD3_right macd3_right;
      macd3_right.init();
      double valueMACD3_right = macd3_right.calc();

      if(valueMACD3_left > valueMACD3_right)
        {
         printf("task"+block_id + " passed route 1");
         block.onResult(ROUTE_1_PASSED);
        }
