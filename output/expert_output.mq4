   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      Task::run(block_id, block);
         ...
         MovingAverage5_left movingaverage5_left;
   movingaverage5_left.init();
   double valueMovingAverage5_left = movingaverage5_left.calc();
         MovingAverage5_right movingaverage5_right;
   movingaverage5_right.init();
   double valueMovingAverage5_right = movingaverage5_right.calc();

      if(valueMovingAverage5_left > valueMovingAverage5_right)
        {
