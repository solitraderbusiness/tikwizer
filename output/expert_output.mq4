...
string price_mode = "my_personal_price_mode"; //
string my_symbol = "EURUSD, NZDUSD"; //
double max_price = 0; //
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      Value13_left value13_left;
      value13_left.init();
      datetime valueValue13_left = value13_left.calc();
      Value13_right value13_right;
      value13_right.init();
      double valueValue13_right = value13_right.calc();

      if(valueValue13_left > valueValue13_right)
        {
         printf("task"+block_id + " passed route 1");
         block.onResult(ROUTE_1_PASSED);
        }
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      Value14_left value14_left;
      value14_left.init();
      double valueValue14_left = value14_left.calc();
      Value14_right value14_right;
      value14_right.init();
      double valueValue14_right = value14_right.calc();
      loop_count = (valueValue14_left + valueValue14_right) + (valueValue14_left + valueValue14_right)*10/NormalizeDouble(100,0);
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      Candle2_left candle2_left;
      candle2_left.init();
      double valueCandle2_left = candle2_left.calc();
      Value2_right value2_right;
      value2_right.init();
      double valueValue2_right = value2_right.calc();

      if(valueCandle2_left > valueValue2_right)
        {
         printf("task"+block_id + " passed route 1");
         block.onResult(ROUTE_1_PASSED);
        }
   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      value3_left.init();
      double valueValue3_left = value3_left.calc();
      Value3_right value3_right;
      value3_right.init();
      double valueValue3_right = value3_right.calc();
      loop_count = (valueValue3_left + valueValue3_right) + (valueValue3_left + valueValue3_right)*10/NormalizeDouble(100,0);
