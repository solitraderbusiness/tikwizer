         ...
         if(do_update)
           {
            ...
            if(object_type == OBJ_TEXT)
              {
               ...
               ObjectSetInteger(obj_chart_id,name,OBJPROP_TIME,0,(long)valueValue2_time_1);

               Value2_price_1 value2_price_1;
               value2_price_1.init();
               datetime valueValue2_price_1 = value2_price_1.calc<datetime>();
               ObjectSetDouble(obj_chart_id,name,OBJPROP_PRICE,0,(double)valueValue2_price_1);
              }
            else
              {
            ...
            value2_text.init();
            datetime valueValue2_text = value2_text.calc<datetime>();

            ObjectSetString(obj_chart_id,name,OBJPROP_TEXT,(string)valueValue2_text);
