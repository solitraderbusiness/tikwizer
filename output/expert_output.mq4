   ...
   virtual void               run(int block_id, BlockParent &block)
     {
      ...
      MovingAverage2_left movingaverage2_left;
      movingaverage2_left.init();
      double valueMovingAverage2_left = movingaverage2_left.calc();
      Value2_right value2_right;
      value2_right.init();
      double valueValue2_right = value2_right.calc();

      if(valueMovingAverage2_left > valueValue2_right)
        {
         printf("task"+block_id + " passed route 1");
         block.onResult(ROUTE_1_PASSED);
        }
