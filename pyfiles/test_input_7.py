...
# test profit unrealized + if trade
input_data_2 = {
    "events": {
        "on_tick": {
            "nodes": [
            ...
            "nodes": [
                {
                    "id": "3e3dd2ce-0aa8-44f4-92ed-7466a1722ae1",
                    "id_by_user": 2,
                    "blockName": "editfield_modified",
                    "params": {
                        "name_filter_mode": "\"names\"",
                        "obj_name": "\"test_name_1, test_name_2\""
                    }
                },
                {
                    "id": "3c61eca7-54f1-40c3-9af2-2888f042d5d2",
...
# DAW: test fill not present data fields
input_data_5 = {
    "events": {
        "on_tick": {
            "nodes": [
