  ...
  "data": {
    "events": {
      ...
      "on_tick": {
        "nodes": [
          {
            ...
            "id": "8a9aa52b-4eb7-4df0-841e-ad614c655045",
            "id_by_user": 14,
            "category": "check_trades_orders_count",
          ...
          },
          {
            ...
            "id": "ee1eda08-89e8-43ba-9117-b7eb7816ebe1",
            "id_by_user": 15,
            "category": "condition_formula",
            "block_name_mql": "condition",
            "blockName": "Condition"
          },
          {
            ...
            "id": "053ed5a7-7e6a-4e24-a35a-99aa9b6e739e",
            "id_by_user": 16,
            "blockName": "Condition",
            "category": "condition_formula",
            "block_name_mql": "condition"
        ...
        "edges": [
          {
            "source": "ee1eda08-89e8-43ba-9117-b7eb7816ebe1",
            "sourceHandle": "blue",
            "target": "8a9aa52b-4eb7-4df0-841e-ad614c655045",
            "targetHandle": "c",
            "type": "customEdge",
            "id": "db344fb2-565c-419d-8b6c-2b11a2a93e3d"
          },
          {
            "source": "053ed5a7-7e6a-4e24-a35a-99aa9b6e739e",
            "sourceHandle": "blue",
            "target": "8a9aa52b-4eb7-4df0-841e-ad614c655045",
            "targetHandle": "c",
            "type": "customEdge",
            "id": "bff32c94-553f-4a56-9081-aa80f8d252b1"
          }
        ]
      },
      "on_trade": {
      ...
      "on_tick": {
        "nodes": [
          ...
          },
          {
            ...
            "id": "199a9bb3-6a3b-4526-bc40-b712f70e5bfb",
            "id_by_user": 4,
            "blockName": "Condition",
            "category": "condition_formula",
            "block_name_mql": "condition"
        ...
        "edges": [
          {
            "source": "199a9bb3-6a3b-4526-bc40-b712f70e5bfb",
            "sourceHandle": "blue",
            "target": "86238671-e966-4039-9899-c6ad77876a67",
            "targetHandle": "c",
            "type": "customEdge",
            "id": "f9fc0c94-6505-47f4-b677-591f9de0df1c"
          }
        ]
      },
      "on_trade": {
