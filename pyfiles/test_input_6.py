# This script represents data input using new structure
            ...
            "nodes": [
                {
                    "id": "361e37db-e957-40fd-b072-3122dfc3e04c",
                    "id_by_user": 20,
                    "blockName": "select_object_by_name",
                    "params": {
                        "obj_name": "\"test name\"",
                    }
                },
...
# Test delete (loop for chart objects)
input_data_6 = {
    "events": {
        "on_tick": {
            "nodes": [
...
# Test check_trendline_price_level
input_data_9 = {
    "events": {
        "on_tick": {
            "nodes": [
                {
                    "id": "361e37db-e957-40fd-b072-3122dfc3e04c",
                    "id_by_user": 20,
                    "blockName": "check_trendline_price_level",
                    "params": {
                        "candle_id": 30,
                        "operator": "!=",
                        "price_level": {
...
# Test on chart event infrastructure
input_data_12 = {
    "events": {
        "on_chart": {
            "nodes": [
